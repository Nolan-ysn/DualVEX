...
class TestConfig:
    ...
    model_path = "/data3/ysn/LoRA_HCP/HCP_7Class_MAE_ST_50_LoRA_20260110_153659/models/best_model_epoch_100_acc_0.8205.pth"
    '''
    "/data3/ysn/LoRA_HCP/HCP_7Class_MAE_ST_20_LoRA_20260109_102541/models/best_model_epoch_28_acc_0.7785.pth"
    "/data3/ysn/LoRA_HCP/HCP_7Class_MAE_ST_50_LoRA_20260110_153659/models/best_model_epoch_100_acc_0.8205.pth"
    "/data3/ysn/LoRA_HCP/HCP_7Class_MAE_ST_100_LoRA_20260112_102817/models/best_model_epoch_59_acc_0.8624.pth"
    "/data3/ysn/LoRA_HCP/HCP_7Class_MAE_ST_200_LoRA_20260113_210800/models/best_model_epoch_61_acc_0.8727.pth"
    "/data3/ysn/LoRA_HCP/HCP_7Class_MAE_ST_900_LoRA_20260114_103321/models/best_model_epoch_4_acc_0.8859.pth"
    '''

    log_dir = "/home/ysn/PycharmProjects/MAE/IBC/result/"

    num_subjects = 50 # 微调时使用的被试数量
    # --- 模型参数 (保持一致) ---
...
def main():
    ...
    logger = get_logger(os.path.join(cfg.log_dir, f"test_lora_{cfg.num_subjects}.log"))
    ...
    if cfg.use_lora:
        ...
        peft_config = LoraConfig(
            ...
            # Attention 里的 qkv, proj; MLP 里的 fc1, fc2
            target_modules=["qkv", "proj", "fc1", "fc2"],
            # 我们要全量训练分类头，所以把它加入 modules_to_save
